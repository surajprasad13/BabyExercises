...
class Header extends Component {
    ...
    render() {
        ...
        let icon = Platform.OS === 'ios' ? require('./../../../assets/back/ios/back.png') : require('./../../../assets/back/android/back.png');
                ...
                <View style={styles.innerContainer}>
                        ...
                        {this.props.navigation.state.routeName != 'Home' &&
                            ...
                            <TouchableWithoutFeedback onPress={() => this.handleBackButton()}>
                                <View style={styles.row}>
                                    ...
                                    {Platform.OS === 'ios' &&
                                        <View style={styles.backText}><Text style={{
                                            fontFamily: "Soho Gothic Pro", color: 'white'}}>{strings.back}</Text></View>}
                    ...
                    <View style={styles.menuButton}>
                        ...
                        <View style={styles.menuButtonTouch}>
                            <Image source={require('./../../../assets/menu/menu.png')} style={styles.icon} />
                            </View>
                        </TouchableWithoutFeedback>
                    </View>
                </View>
